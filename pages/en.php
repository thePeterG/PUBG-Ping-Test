<?php head(); ?>
<nav><div class="orange nav-wrapper"><a href="/" class="white-text brand-logo center">PUBG PING Test</a><div style="color: #fff; margin-left:"><img src="/images/logo.png" alt="ReactionGaming"></div></div></nav>
